package org.hiphone.dubbo.constants;
...
public class Constant {
    ...
    public static final String SWAGGER_BASE_PACKAGE = "org.hiphone.dubbo";

    public static final String SWAGGER_TITLE = "Spring-Boot-Demo RESTful API 文档";

    public static final String SWAGGER_DESCRIPTION = "Spring boot dubbo";
